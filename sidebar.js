document.addEventListener("DOMContentLoaded", function() {
    ...
    const menuItems = [
        ...
        { name: "Data Explorer", href: "data-explorer.html", indent: true }
    ];
    ...
    menuItems.forEach(item => {
        ...
        const indentStyle = item.indent ? ' style="padding-left:2rem;font-size:0.9em;"' : '';
        html += `<li><a href="${item.href}" ${isActive}${indentStyle}>${item.name}${showLock ? lockIcon : ''}</a></li>`;
    });
    html += '</ul>';
